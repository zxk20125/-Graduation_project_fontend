...
public class TStaff {
	...
	public TStaff(Integer staffId, String staffName, String staffLoginName, String staffPassword, Integer staffAge,
			String staffSex, String staffPhone, Date hiredate, Integer dotId, TDot dot) {
		this.staffId = staffId;
		this.staffName = staffName;
		this.staffLoginName = staffLoginName;
		this.staffPassword = staffPassword;
	...
	public String toString() {
		return "TStaff [staffId=" + staffId + ", staffName=" + staffName + ", staffLoginName=" + staffLoginName
				+ ", staffPassword=" + staffPassword + ", staffAge=" + staffAge + ", staffSex=" + staffSex
				+ ", staffPhone=" + staffPhone + ", hiredate=" + hiredate + ", dotId=" + dotId + ", dot=" + dot + "]";
	}
