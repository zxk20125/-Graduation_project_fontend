...
<body>
	...
	<section class="aui-flexView">
		<header class="aui-navBar aui-navBar-fixed b-line">
			...
			<div class="aui-center">
				<span class="aui-center-title">新增地址</span>
			</div>
		...
		<section class="aui-scrollView">
			<div class="aui-address-box">
				...
				<div class="aui-address-cell-item">
					...
					<div class="aui-cell-input">
						<input type="text" class="cell-input" id="phone"
							placeholder="收件人电话号码" autocomplete="off" ">
					</div>
				</div>
				<div class="aui-address-cell-item">
				...
				<div class="aui-address-btn">
					<a href="javascript:;" onclick="doinsert();">确定</a>
				</div>
	...
	<script type="text/javascript">
		function doinsert() {
			...
			//console.log(data)
			 $.post(getContextPath() + "/qtCustomer/address/doinsert.do", data,
					function(msg) {
						if (msg == 1) {
							alert("添加成功！");
