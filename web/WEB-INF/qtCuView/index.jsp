...
<html>
	...
	<body>
        ...
        <div class="search">
           ...
           <input type="text" class="search-text" value="查询运单" onchange="sousuo();" id="sou"/>
        </div>

		  </header>
		<div class="banner"><img src="${ctx}/qtCustomer/images/zjs.jpg"/></div>
		<ul class="menu">
		
			<li>
				<a href="${ctx}/qtCustomer/address/list.do" class="menu-box">
					<p>地址簿</p>
					<i class="iconfont">&#xe607;</i>
				</a>
			</li>
				<li>
				<a href="${ctx}/qtCustomer/dot/select.do" class="menu-box">
					<p>网点查询</p>
					<i class="iconfont">&#xe605;</i>
				</a>
			</li>
				<li>
				<a href="${ctx}/qtCustomer/freight/xianshi.do" class="menu-box">
					<p>运费估算</p>
					<i class="iconfont">&#xe606;</i>
				</a>
			</li>
				<li>
				<a href="${ctx}/qtCustomer/feedback/insert.do" class="menu-box">
					<p>反馈建议</p>
					<i class="iconfont">&#xe608;</i>
				</a>
			</li>
...
function sousuo(){
	...
	$.post(getContextPath()+"/qtCustomer/order/sousuo.do",data,function(msg){ 
		if(msg==1){
